    ...
    <>
      ...
      <main>
        <section className="content fluid">
          <h2><span aria-hidden="true">I am a&nbsp;</span>
        ...
        <section className="about-me">
          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <p>When I’m not coding or designing, you can find me hiking, rock climbing, playing or watching sports (mostly women's sports of course), or hanging out with my friends and family.</p>
            </div>
          </div>
        </section>
        <section className="work" id="work">
          ...
          {/* <div id="app" className="container">
            <div className="work-card" onClick={() => goTo('/atlas')}>
              <h1>The Atlas</h1>
              <p>iOS and Web App</p>
            </div>
            <div className="about-card" onClick={() => goTo('/submitty')}>
              <h1>Submitty</h1>
              <p>VSCode Extension</p>
            </div>
            <div className="contact-card" onClick={() => goTo('/grindhaus')}>
              <h1>Grindhaus Coffee Co</h1>
              <p>Website</p>
            </div>
            <div className="contact-card" onClick={() => goTo('/optima')}>
              <h1>Optima</h1>
              <p>Type Specimen</p>
            </div>
          </div> */}
          ...
          <div className="contact-row">
            ...
            <div className="contact-info">
              <div>
                ...
                <p><a href="email">sophia.a.kist@gmail.com</a></p>
              </div>
              <div className="socials">
                <a href="https://github.com/sophiakist" target="_blank" aria-label="GitHub">
                  <svg width="35" height="35" fill="currentColor" viewBox="0 0 24 24"><path d="M12 .3a12 12 0 0 0-3.8 23.4c.6.1.8-.2.8-.6v-2.2c-3.3.7-4-1.6-4-1.6-.5-1.2-1.2-1.5-1.2-1.5-1-.7.1-.7.1-.7 1.1.1 1.7 1.1 1.7 1.1 1 .1.8 1.6 2.7 1.1.1-.7.4-1.1.7-1.4-2.7-.3-5.5-1.3-5.5-5.7 0-1.3.5-2.3 1.2-3.2-.1-.3-.5-1.5.1-3.1 0 0 1-.3 3.3 1.2a11.5 11.5 0 0 1 6 0c2.3-1.5 3.3-1.2 3.3-1.2.6 1.6.2 2.8.1 3.1.8.9 1.2 2 1.2 3.2 0 4.4-2.8 5.4-5.5 5.7.4.3.8 1 .8 2v3c0 .4.2.7.8.6A12 12 0 0 0 12 .3"/></svg>
                </a>
                <a href="https://www.linkedin.com/in/sophia-kist-3375bb237/" target="_blank" aria-label="LinkedIn">
                  <svg width="35" height="35" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11 19h-3v-9h3v9zm-1.5-10.28c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.5 10.28h-3v-4.5c0-1.08-.02-2.47-1.5-2.47-1.5 0-1.73 1.17-1.73 2.39v4.58h-3v-9h2.89v1.23h.04c.4-.76 1.38-1.56 2.84-1.56 3.04 0 3.6 2 3.6 4.59v5.74z"/></svg>
                </a>
              </div>
            </div>
          </div>
